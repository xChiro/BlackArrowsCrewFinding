...
public static class CrewCreatorInitializer
{
    ...
    {
        var sut = new CrewCreator(crewCommandRepository, new CrewQueriesMock(), maxCrewAllowed,
    ...
    {
        var sut = new CrewCreator(crewCommandRepository, new CrewQueriesMock(), 4, playerQueriesValidationMock);
