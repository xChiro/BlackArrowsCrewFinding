...
public class CrewPartyCommandTests
{
    ...
    public async Task Create_A_Crew_Party_Successfully()
    {
        ...
        var crewParty = new CrewParty(Player.Create("24", "Rowan"), new CrewName("Rowan"), Location.DefaultLocation(),
            LanguageCollections.Default(), new CrewCapacity(10, 10), Activity.Default(), DateTime.UtcNow);
